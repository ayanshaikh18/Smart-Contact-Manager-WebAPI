<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupList.aspx.cs" Inherits="WebClient.Groups.GroupList" MasterPageFile="~/Site.Master" Async="true" %>
    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-12 float-right" style="text-align:right">
                <asp:HyperLink CssClass="btn btn-primary" ID="CreateContactLink" runat="server" NavigateUrl="~/Groups/NewGroup.aspx">Create new Group</asp:HyperLink>
            </div>
        </div>
